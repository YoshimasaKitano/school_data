    ...
    <main>
        ...
        <div class="formpage">
            ...
            <form action="confirm.php" method="POST">
                ...
                <p class="formtext">
                    <label>性別：(必須)</label>
                    <label><input type="radio" name="gender" value="男性" class="gendertext">男性</label>
                ...
                <p class="formtext"><label><input type="checkbox" name="agree" value="personal" <?= isset($_SESSION['original']['agree']) && $_SESSION['original']['agree'] === 'personal' ? 'checked' : '' ?>>個人情報保護法に同意します。(必須)</label></p>
