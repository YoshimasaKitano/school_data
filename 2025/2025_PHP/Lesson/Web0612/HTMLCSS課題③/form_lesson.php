    ...
    <main>
        ...
        <div class="formpage">
            ...
            <form action="confirm.php" method="POST">
                ...
                <p class="formtext"><label>お名前：(必須)<input type="text" name="name" placeholder=" お名前" class="formbox"></label></p>
                <p class="formtext"><label>メールアドレス：(必須)<input type="email" name="email" placeholder=" example.123@example.cor" class="formbox"></label></p>
                ...
                <p class="formtext">
                    <label>OCAサファリパークはいかがでしたか？ご意見・ご感想をお願いします！</label><br>
                    <textarea name="comment" cols="120" rows="12" placeholder="コメントを入力してください"></textarea>
                </p>
                <p class="formtext"><label><input type="checkbox" value="personal">個人情報保護法に同意します。</label></p>
                <p class="formtext"><a href="" class="formpersonal">個人情報のお取扱いについて</p>
                <ul>
